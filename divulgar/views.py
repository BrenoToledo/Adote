...
def novo_pet(request):
    if request.method == 'GET':
        ...
        return render(request,'novo_pet.html', context={'tags' : tags, 'racas' : racas})
...
def remover_pet(request, id):
    ...
    if not pet.usuario == request.user:
        messages.add_message(request, constants.SUCCESS, 'Esse PET não é seu! espertinho KKKK  ')
        return redirect('/divulgar/seus_pets')
    pet.delete()
...
@csrf_exempt # Faz com que esta view não precise de verificação csrf
